<template>
  <div class="hello">
    <div class="container">
      ...
      <div style="width:100px;height:100px" ref="background" :style="{background: divBg}">
  ...
  watch: {
    nb (value) {
      if (value >= 91 && value <= 110) {
        this.$refs.background.style.backgroundColor = 'red';
      }
      if (value > 71 && value < 90) {
         this.$refs.background.style.backgroundColor = 'orange';
      }
      if (51 <= value <= 70) {
         this.$refs.background.style.backgroundColor = 'purple';
      }
      if (31 <= value <= 50) {
        this.$refs.background.style.backgroundColor = 'blue';
      }
      if (11 <= value <= 30) {
         this.$refs.background.style.backgroundColor = 'green';
      }
      if (0 <= value && value <= 10) {
         this.$refs.background.style.backgroundColor = 'gray';
      }
    }
  }
}
