  ...
  <div class="productList">
    <table>
      ...
      <tr>
        <td>{{ product.id }}</td>
        <td>
          <span class="textMain">{{ product.name }}</span>
        </td>
        ...
        <td>
          ...
          <button class="deleteButton" @click="deleteProduct(index)">
            Xóa
          </button>
        </td>
      </tr>
    ...
    <div class="paginationWrap">
      ...
      <div>
        <button
          ...
          @click="goPrePage"
          :class="{ isButtonDisabled: isGoPrePageDisabled }"
        >
        ...
        <button
          class="paginationButton"
          @click="goNextPage"
          :class="{ isButtonDisabled: isGoNextPageDisabled }"
        >
